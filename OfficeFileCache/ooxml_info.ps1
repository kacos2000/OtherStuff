...
$ooxml = Get-ChildItem $Folder -include *.xlsx,*.pptx,*.docx,*.zip -Recurse
if($ooxml.count -ge 1){
...
$contents = [io.compression.zipfile]::OpenRead($oo.fullname).entries
...
$Properties|sort -Property file |Out-GridView


# SIG # Begin signature block
# MIIfcAYJKoZIhvcNAQcCoIIfYTCCH10CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCWszWgrzamg31e
# WOqlczglA8XzKc78lTl3mBdLWW7pLKCCGf4wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgFbs3YPslC6CynMjn
# u3MieyeazH6u2eUQGd+7cA/fy3wwDQYJKoZIhvcNAQEBBQAEggEAfJs/21Vsm8ui
# LI1yKSGGQEM4dze8zYBBsA0+MNirzfDRxbfyeDpvyolHnRtOp1ui9xEWOpF+wX/V
# KFvEbJH19gtZPY3lKT7munl1zNNFyo8UQr66Xmh2YIgRab9d0KsTa1HRFubiuFFt
# e8ww64UlDiJdEeG4apoSZirSX22kpn54T5UNoFy+n3u4943QqAdMJbxccsaB6BRA
# bjBH8PzDKKIsJEM6Jo6oNFnBoCymnQ1naU2jMcbmmKA7BAPqL91k3QQbPkYWkqcb
# waWZLo7AZiN3QinJ4F0TAwfNyh3k0Zxm2qZfZCi/dBfI+irD1U/LlnS7hcpU/ReV
# wpnwYhK67qGCArkwggK1BgkqhkiG9w0BCQYxggKmMIICogIBATBrMFsxCzAJBgNV
...
# HAYJKoZIhvcNAQkFMQ8XDTIwMDQwMjE2Mzc0OFowLwYJKoZIhvcNAQkEMSIEIFDz
# Lt3PGUNmv2mPhD6ovDwdVAAlWWMWgvEnPo8GSC4sMIGgBgsqhkiG9w0BCRACDDGB
...
# eDANBgkqhkiG9w0BAQEFAASCAQBE+kHwnE6iMO6Q/eV4GTJ3hU8LiEBdy8e9LpSe
# X1R1DlDeYjBuZe3i/Clwx3YnPR5HRLF1MJ8vbH4bj62bZ6/wD0jGx9Fvj0qqLD9e
# VQmGTQTLEbuZaM4D+pA42DP/u4Em8Ne8EJEbHHKv0zczIShPysDED23+gSromZGN
# kj+nnwhCU2uOftFOjFWBb9k3qUJ8P/tzomTnjx1r6iIYHr+gw/SalmKhtjMi1Tn/
# T9IpHeZODP2o/9EXa2ZdHCyYT7UkKUQBYW0Kn5U2ZVByUrqAj4weQus2KjkpMMOq
# Kbj6eVNOkU77ZbG3VLMIoEkXiECmmP4OIJtrtslh1hX7jk23
